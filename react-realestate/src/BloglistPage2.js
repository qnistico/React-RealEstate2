          ...
          <div className="blog_box">
            <div className="blog_list blog_list_1">
              ...
              <div className="blog_item bi_2">
                <div className="blog_img">
                  <a onClick={() => history.push("/SellingAHome")}><img
                    src={blogimg3}
                    alt=""
                  /></a>
                </div>
                <div className="blog_item_content">
                  <a onClick={() => history.push("/SellingAHome")} className="blog_title">
                    Selling Homes
                  </a>
                  <p className="blog_date">01/01/2021</p>
                  <p className="blog_description">
                  ...
                  <a onClick={() => history.push("/SellingAHome")} className="blog_button ">
                    Read More <ArrowForwardIosIcon />
                  </a>
                </div>
              </div>
            ...
            <div className="blog_list">
              <div className="blog_item bi_3">
                <div className="blog_img">
                  <a onClick={() => history.push("/ValuingYourHome")}><img
                    src={blogimg2}
                    alt=""
                  /></a>
                </div>
                <div className="blog_item_content">
                  <a onClick={() => history.push("/ValuingYourHome")} className="blog_title">
                    Buying a Home
                  </a>
                  <p className="blog_date">01/01/2021</p>
                  <p className="blog_description">
                  ...
                  <a onClick={() => history.push("/ValuingYourHome")} className="blog_button ">
                    Read More <ArrowForwardIosIcon />
                  </a>
                </div>
              </div>
              <div className="blog_item bi_4">
                <div className="blog_img">
                  <a onClick={() => history.push("/FindingTheRightLocation")}><img
                    src={blogimg1}
                    alt=""
                  /></a>
                </div>
                <div className="blog_item_content">
                  <a onClick={() => history.push("/FindingTheRightLocation")} className="blog_title">
                    Buying a Home
                  </a>
                  <p className="blog_date">01/01/2021</p>
                  <p className="blog_description">
                  ...
                  <a onClick={() => history.push("/FindingTheRightLocation")} className="blog_button ">
                    Read More <ArrowForwardIosIcon />
                  </a>
                </div>
              </div>
